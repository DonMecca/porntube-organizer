...
function decodeConfig(raw) {
  ...
  try {
    ...
    // Reject arrays: `typeof [] === 'object'`, and normalizeConfig would happily
    // promote one to a valid-looking config with an empty studio list, so a
    // malformed token produced a silently "configured" manifest.
